...
void CameraMovementSystem::tick() {
	...
	glm::mat4 view = glm::lookAt(transform->m_position,
				     transform->m_position + transform->m_forward,
				     transform->m_up);
